...
$qury_sel="select * from `product` limit 8 offset $q";
...
{?>
  ...
  <div class="w3-card-4">
                ...
                <div class="g_pro_name"><?php echo $fet_sel['name'];?>
                </div>
                ...
                Quantity :<input type="text" value="1" class="input_type" id="<?php echo $fet_sel['product_id'];?>qan">Kg


                <input type="submit" value="Buy Now" class="butto" id="<?php echo $fet_sel['product_id'];?>buy" onclick="buy_item(this.id)">
