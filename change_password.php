...
<script src="profileE1.js"></script>
<meta charset="utf-8">
...
<div class="content">
  ...
  <div class="filters">
    ...
    <div class="space"align="center"></div>
          ...
          <br><br>
          						<div id="s"><span id="ud">Confirm Password&nbsp&nbsp:</span></div><div id="s1"><input type="text" id="mid"><br><span id="smid" class="spn"></span></div><br>
          						<br><br>
