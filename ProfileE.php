...
<div class="content">
  			...
  			<div class="product" id="hk">
					...
					$uid= $_SESSION['uid'];
					$qury_sel="select * from `signup` where uid='$uid'";
					...
					while($fet_sel =mysql_fetch_array($res_sel)){?>
						...
						<div id="s"><span id="ud">User Name&nbsp&nbsp:</span></div><div id="s1"><input type="text" id="uid" value="<?php echo $fet_sel['user_id'];?>"placeholder="User_id"><br><span id="suid" class="spn"></span></div><br>


						<br><br>
						<div id="s"><span id="ud">Email&nbsp&nbsp:</span></div><div id="s1"><input type="text" id="eid" value="<?php echo $fet_sel['email_id'];?>" placeholder="email_id"><br><span id="seid" class="spn"></span></div><br>

<br><br>
						<div id="s"><span id="ud">Mobile&nbsp&nbsp:</span></div><div id="s1"><input type="text" id="mid" value="<?php echo $fet_sel['mobno'];?>"placeholder="mobno"><br><span id="smid" class="spn"></span></div><br>


						<br><br>
						<div id="s"><span id="ud">Gender&nbsp&nbsp:</span></div><div id="s1"><input type="text" id="sid" value="<?php echo $fet_sel['gender'];?>"placeholder="gender"><br><span id="ssid" class="spn"></span></div><br>

<br><br>
						<div id="s"><span id="ud">Address&nbsp&nbsp:</span></div><div id="s1"><input type="text" id="gid" value="<?php echo $fet_sel['adress'];?>"placeholder="address"><br><span id="sgid" class="spn"></span></div><br>
